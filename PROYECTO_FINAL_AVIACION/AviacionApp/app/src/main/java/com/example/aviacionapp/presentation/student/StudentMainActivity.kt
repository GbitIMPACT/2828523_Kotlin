package com.example.aviacionapp.presentation.student
...
import com.example.aviacionapp.databinding.ActivityStudentMainBinding
...
class StudentMainActivity : AppCompatActivity() {
    ...
    private fun logout() {
        lifecycleScope.launch {
            ...
            val intent = Intent(this@StudentMainActivity, LoginActivity::class.java)
